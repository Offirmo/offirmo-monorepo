...
function get_bolt_workspaces_and_modules(): Immutable<> {
...
const MONOREPO_PKG_JSON_PATH = path.resolve(MONOREPO_ROOT, 'package.json')
const MONOREPO_PKG_JSON = loadJsonFile(MONOREPO_PKG_JSON_PATH)
