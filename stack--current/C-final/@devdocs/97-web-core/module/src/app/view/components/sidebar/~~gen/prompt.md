...
- the graph is the output of `import { getꓽall } from '@devdocs/db'` (follow the code to find the types and data structure)
...
- optionally takes as input an instance of `import type { State } from '@devdocs/state'` (follow the code to find the types and data structure)
