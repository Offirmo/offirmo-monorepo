...
/*
SPECIFICATIONS
- Render a semantic, collapsible tree view for a graph based on `getꓽall()` from `@dev-docs--web3/db`.
- Accept an immutable `state?: State` from `@dev-docs--web3/state` (optional; defaults to all-enabled).
...
const DEFAULT_STORAGE_KEY = '@dev-docs--web3/web-core/sidebar/codex/open-state/v1'
