...
const init = once(async function loadꓽcss(): Promise<void> {
	...
	//import('@monorepo-private/css--framework') NO already imported through entry point (bc critical for some vars)
	import('@monorepo-private/css--utils--diagnostics')

	window.document.documentElement.dataset['oTheme'] = 'dark--colorhunt212'
	import('@monorepo-private/css--framework/src/themes/theme--dark--colorhunt212.css')
