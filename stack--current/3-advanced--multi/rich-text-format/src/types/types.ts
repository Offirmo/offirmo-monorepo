...
import { type Emoji, type Uri‿str } from '@offirmo-private/ts-types'
...
interface Hints {
	href?: Uri‿str // make this node a link to a specific resource
	...
	// TODO Hypermedia as first class!

	// TODO clarify
	//uuid?: string // for ex. to recognize a specific resource
}
