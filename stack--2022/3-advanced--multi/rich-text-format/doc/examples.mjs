...
} = require('../../../9-oh-my-rpg/logic-weapons/dist/src.es2022.cjs')
const {
	DEMO_ARMOR_1,
	DEMO_ARMOR_2,
	//generate_random_demo_armor,
} = require('../../../9-oh-my-rpg/logic-armors/dist/src.es2022.cjs')

const {
	render_item_short,
	//render_item_detailed,
} = require('../../../9-oh-my-rpg/view-rich-text/dist/src.es2022.cjs')
*/
